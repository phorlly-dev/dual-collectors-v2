...
| `src/hooks/remote.js`           | A simple event bus to communicate between React and Phaser.                                           |
| `src/game`                      | Contains the game source code.                                                                        |
| `src/game/index.js`             | The main **game** entry point. This contains the game configuration and starts the game.              |
